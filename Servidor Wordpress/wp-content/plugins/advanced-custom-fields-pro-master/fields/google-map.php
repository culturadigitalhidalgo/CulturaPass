...
<div <?php acf_esc_attr_e($atts); ?>>
	...
	<div class="acf-hidden">
		<?php foreach( $field['value'] as $k => $v ): ?>
			...
			<input id="mytext<?php echo $k; ?>" type="text" class="input-<?php echo $k; ?>" name="<?php echo esc_attr($field['name']); ?>[<?php echo $k; ?>]" value="<?php echo esc_attr( $v ); ?>" />
		<?php endforeach; ?>
	</div>
	...
	<div id="mapa_canvas" class="canvas" style="display:none; height: <?php echo $field['height']; ?>px"></div>
	<div id = "mapcic" class="canvas" style="height: <?php echo $field['height']; ?>px"></div>
...
<?php 
/*Arreglo para poner mapa solo en post que son tipo creadores y/o patrimonio*/
$postType = get_post_type_object(get_post_type($_GET["post"]));
if ( $postType->name == "patrimonio" || $postType->name == "creadores" || $_GET["post_type"] == "patrimonio" || $_GET["post_type"] == "creadores")
{
?>
<script>
jQuery(function($){ 
