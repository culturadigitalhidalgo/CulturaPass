...
function getDisciplinas () {
	jQuery.ajax({
            url:   '../wp-content/themes/EspecialesT2/eventos/ajax/get_disciplinas-independiente.php',
            type:  'post',
...
function getMunicipios () {
	jQuery.ajax({
        url:   '../wp-content/themes/EspecialesT2/eventos/ajax/get_municipios-independiente.php',
        type:  'post',
        success:  function (response) {
...
function getPublicos () {
	jQuery.ajax({
            url:   '../wp-content/themes/EspecialesT2/eventos/ajax/get_publico-independiente.php',
            type:  'post',
            success:  function (response) {
...
//    jQuery('input[name="submit"]').click(function() {
		...
		var Publico = jQuery( "#selPublico option:selected" ).val();
            ...
            jQuery.ajax({
                    ...
                    url: "../wp-content/themes/EspecialesT2/eventos/ajax/filtro_eventos_ajax-independiente.php",
                    data: parametros,
                    beforeSend: function () {
...
<!-- VEDA -->
			<div class="CCA2">	 
				<a href="<?php echo get_permalink($event_id); ?>" title="<?php echo $post->post_title; ?>" target="_blank"><img src="http://cultura.hidalgo.gob.mx/wp-content/uploads/2018/11/pdaach-1.png "></a>
			</div>
