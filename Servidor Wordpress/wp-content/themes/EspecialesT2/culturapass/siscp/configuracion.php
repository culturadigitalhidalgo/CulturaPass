...
//plantilla V4.0
    ...
    $tablabase="configuracion";
    $idbase="idconfiguracion";
    $paginabase=$selfpag;
    
    //Variables Globales del Archivo (pueden ser omitidas) texto desplegado en los formularios de catálogos
    $textoencabezado="Configuración";
    $textoencabezadoforms="Configuración";
    
    //Variables para obtención de información en grid data table
    $camposrs="idconfiguracion as IDConfiguracion, descripcionconfig as 'Descripción Configuración', valor as 'Valor Configuración'";
    $tablars=$tablabase;
    $wherers="1";
    $idaccion="IDConfiguracion";
    
    //Variables para generación de formularios y almacen de datos $campos['Nombre_campo']="aray de atributos";    
    $atribs['tipo']="texto";
    $atribs['label']="Descripción Configuración";
    $atribs['obligatorio']=true; 
    $campos['descripcionconfig']=$atribs;
    unset($atribs);
    $atribs['tipo']="texto";
    $atribs['label']="Valor";
    $atribs['obligatorio']=true; 
