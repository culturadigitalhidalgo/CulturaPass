...
* 
* @category Resultados finalistas
...
$pdf->SetTitle('Resultado finalistas');
$pdf->SetSubject('Resultado finalistas');
$pdf->SetKeywords('Resultado finalistas - - CIC');
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -		
//$toolcopy = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="'.K_PATH_IMAGES.'img_1.jpg"  width="60" height="60">';
//$pdf->writeHTML($toolcopy, true, false, true, false, '');

// print a block of text using Write()


$pdf->Write(0, '                      aáaAäÁ  LISTA DE FINALISTAS', '', 0, 'L', true, 0, false, false, 0);
...
$pdf->Output('Resultado_finalistas.pdf', 'I');
