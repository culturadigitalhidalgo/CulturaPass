                            ...
                            formSubmit: {
                                ...
                                action: function () {
                                    if(!valida("#FormAgrega")){
                                        ...
                                        $('#FormAgrega input').each(function(){
                ...
                $('#informacion').on('click','a.modificar',function(e){
                    ...
                    $.confirm({
                        ...
                        onContentReady: function () {
                            ...
                            $('#FormModifica input').each(function(){
