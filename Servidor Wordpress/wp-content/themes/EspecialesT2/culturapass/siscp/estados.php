...
//plantilla V4.0
    ...
    $textoencabezado="Estados";
    $textoencabezadoforms="Estado";
    
    //Variables para obtención de información en grid data table
    $camposrs="idestado as IDEstado, estado as Estado, siglas as Siglas";
    $tablars=$tablabase;
    $wherers="1";
    $idaccion="IDEstado";
    ...
    $atribs['label']="Estado";
    $atribs['obligatorio']=true; 
    $campos['estado']=$atribs;
    unset($atribs);
    $atribs['tipo']="texto";
    $atribs['label']="Siglas";
    $atribs['obligatorio']=true; 
    $campos['siglas']=$atribs;
    unset($atribs);
                            /***********************Configuración****************************/
